...
public class IronHorseArmorRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_iron_horse_armor"), new ItemStack(Material.IRON_HORSE_ARMOR));
        shapedRecipe.shape("XXX", "XYX", "XXX");

        shapedRecipe.setIngredient('X', Material.IRON_INGOT);
        shapedRecipe.setIngredient('Y', Material.LEATHER_HORSE_ARMOR);
