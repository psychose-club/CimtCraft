...
public final class ZombieHorseSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_zombie_horse_spawn_egg"), new ItemStack(Material.ZOMBIE_HORSE_SPAWN_EGG));
        shapedRecipe.shape("WWW", "XYX", "ZZZ");

        shapedRecipe.setIngredient('W', Material.ROTTEN_FLESH);
