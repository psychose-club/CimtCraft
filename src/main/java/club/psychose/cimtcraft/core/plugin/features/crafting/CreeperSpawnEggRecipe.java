...
public final class CreeperSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_creeper_spawn_egg"), new ItemStack(Material.CREEPER_SPAWN_EGG));
