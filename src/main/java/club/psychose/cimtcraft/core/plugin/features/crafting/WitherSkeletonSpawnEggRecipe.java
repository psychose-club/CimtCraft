...
public final class WitherSkeletonSpawnEggRecipe extends CraftingRecipe {

    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_wither_skeleton_spawn_egg"), new ItemStack(Material.WITHER_SKELETON_SPAWN_EGG));
