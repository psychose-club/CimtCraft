...
public final class MagmaCubeSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_magma_cube_spawn_egg"), new ItemStack(Material.MAGMA_CUBE_SPAWN_EGG));
        ...
        shapedRecipe.setIngredient('Z', Material.SLIME_SPAWN_EGG);
