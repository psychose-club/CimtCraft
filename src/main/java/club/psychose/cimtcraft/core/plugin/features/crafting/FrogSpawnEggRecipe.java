...
public final class FrogSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_frog_spawn_egg"), new ItemStack(Material.FROG_SPAWN_EGG));
        shapedRecipe.shape("XXX", "XYX", "ZZZ");

        shapedRecipe.setIngredient('X', Material.TADPOLE_SPAWN_EGG);
        shapedRecipe.setIngredient('Y', Material.HEART_OF_THE_SEA);
        shapedRecipe.setIngredient('Z', Material.PEARLESCENT_FROGLIGHT);
