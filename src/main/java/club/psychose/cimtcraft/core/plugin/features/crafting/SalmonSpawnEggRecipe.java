...
public final class SalmonSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_salmon_spawn_egg"), new ItemStack(Material.SALMON_SPAWN_EGG));
        shapedRecipe.shape("XXX", "XYX", "XXX");

        shapedRecipe.setIngredient('X', Material.SALMON_BUCKET);
