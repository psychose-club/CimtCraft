...
public final class EndermanSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_enderman_spawn_egg"), new ItemStack(Material.ENDERMAN_SPAWN_EGG));
        ...
        shapedRecipe.setIngredient('Z', Material.ENDERMITE_SPAWN_EGG);
