...
public final class WitchSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_witch_spawn_egg"), new ItemStack(Material.WITCH_SPAWN_EGG));
        shapedRecipe.shape("XXX", "ZYZ", "XXX");

        shapedRecipe.setIngredient('X', Material.SOUL_TORCH);
        shapedRecipe.setIngredient('Y', Material.HEART_OF_THE_SEA);
        shapedRecipe.setIngredient('Z', Material.ENCHANTING_TABLE);
