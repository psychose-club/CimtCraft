...
public class SaddleRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_saddle"), new ItemStack(Material.SADDLE));
        shapedRecipe.shape("   ", "XXX", "XXY");

        shapedRecipe.setIngredient('X', Material.LEATHER);
        shapedRecipe.setIngredient('Y', Material.LEAD);
