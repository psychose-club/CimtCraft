...
public final class PillagerSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_pillager_spawn_egg"), new ItemStack(Material.PILLAGER_SPAWN_EGG));
        shapedRecipe.shape("XXX", "ZYZ", "XXX");

        shapedRecipe.setIngredient('X', Material.CROSSBOW);
