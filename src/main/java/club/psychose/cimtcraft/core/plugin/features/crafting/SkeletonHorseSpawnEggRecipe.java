...
public final class SkeletonHorseSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_skeleton_horse_spawn_egg"), new ItemStack(Material.SKELETON_HORSE_SPAWN_EGG));
        shapedRecipe.shape("WWW", "XYX", "ZZZ");

        shapedRecipe.setIngredient('W', Material.GOLDEN_CARROT);
        shapedRecipe.setIngredient('X', Material.NETHER_STAR);
        shapedRecipe.setIngredient('Y', Material.HEART_OF_THE_SEA);
        shapedRecipe.setIngredient('Z', Material.BLAZE_POWDER);
