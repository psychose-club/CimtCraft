...
public final class ChickenSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_chicken_spawn_egg"), new ItemStack(Material.CHICKEN_SPAWN_EGG));
