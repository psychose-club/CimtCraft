...
public final class ZombifiedPiglinSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_zombified_piglin_spawn_egg"), new ItemStack(Material.ZOMBIFIED_PIGLIN_SPAWN_EGG));
