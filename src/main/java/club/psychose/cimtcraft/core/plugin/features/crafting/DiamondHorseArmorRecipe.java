...
public class DiamondHorseArmorRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_diamond_horse_armor"), new ItemStack(Material.DIAMOND_HORSE_ARMOR));
