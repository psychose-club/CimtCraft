...
public final class GoatSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_goat_spawn_egg"), new ItemStack(Material.GOAT_SPAWN_EGG));
        shapedRecipe.shape("XXX", "XYX", "XXX");

        shapedRecipe.setIngredient('X', Material.GOAT_HORN);
