...
public final class VillagerSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_villager_spawn_egg"), new ItemStack(Material.VILLAGER_SPAWN_EGG));
