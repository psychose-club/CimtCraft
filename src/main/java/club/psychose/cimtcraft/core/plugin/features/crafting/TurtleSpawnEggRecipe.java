...
public final class TurtleSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_turtle_spawn_egg"), new ItemStack(Material.TURTLE_SPAWN_EGG));
