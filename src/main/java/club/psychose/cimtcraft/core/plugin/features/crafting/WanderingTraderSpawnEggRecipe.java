...
public final class WanderingTraderSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_wandering_trader_spawn_egg"), new ItemStack(Material.WANDERING_TRADER_SPAWN_EGG));
        shapedRecipe.shape("XXX", "ZYZ", "XXX");

        shapedRecipe.setIngredient('X', Material.BLUE_CARPET);
