...
public final class PandaSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_panda_spawn_egg"), new ItemStack(Material.PANDA_SPAWN_EGG));
        shapedRecipe.shape("XXX", "XYX", "XXX");

        shapedRecipe.setIngredient('X', Material.BAMBOO);
