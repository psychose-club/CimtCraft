...
public final class HorseSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_horse_spawn_egg"), new ItemStack(Material.HORSE_SPAWN_EGG));
        shapedRecipe.shape(" X ", "XYX", "ZZZ");

        shapedRecipe.setIngredient('X', Material.SADDLE);
        shapedRecipe.setIngredient('Y', Material.HEART_OF_THE_SEA);
        shapedRecipe.setIngredient('Z', Material.LEATHER);
