...
public final class VindicatorSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_vindicator_spawn_egg"), new ItemStack(Material.VINDICATOR_SPAWN_EGG));
        shapedRecipe.shape("WWW", "XYZ", "WWW");

        shapedRecipe.setIngredient('W', Material.OAK_LOG);
        shapedRecipe.setIngredient('X', Material.IRON_AXE);
