...
public final class AxolotlSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_axolotl_spawn_egg"), new ItemStack(Material.AXOLOTL_SPAWN_EGG));
        shapedRecipe.shape(" W ", "XYX", "ZZZ");

        shapedRecipe.setIngredient('W', Material.PINK_DYE);
