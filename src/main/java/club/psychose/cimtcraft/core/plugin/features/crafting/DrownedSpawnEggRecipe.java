...
public final class DrownedSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_drowned_spawn_egg"), new ItemStack(Material.DROWNED_SPAWN_EGG));
        shapedRecipe.shape(" X ", "ZYZ", "XXX");

        shapedRecipe.setIngredient('X', Material.TRIDENT);
