...
public final class ParrotSpawnEggRecipe extends CraftingRecipe {
    @Override
    public ShapedRecipe getCraftingRecipe() {
        ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(CimtCraft.getPlugin(CimtCraft.class), "crafting_parrot_spawn_egg"), new ItemStack(Material.PARROT_SPAWN_EGG));
        ...
        shapedRecipe.setIngredient('Z', Material.COOKIE);
